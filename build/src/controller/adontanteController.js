...
var AdotanteController = /** @class */ (function () {
    ...
    AdotanteController.prototype.criaAdotante = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, nome, senha, celular, foto, endereco, novoAdotante, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, nome = _a.nome, senha = _a.senha, celular = _a.celular, foto = _a.foto, endereco = _a.endereco;
                        novoAdotante = new AdotanteEntity_1.default(nome, senha, celular, endereco, foto);
